...
ALTER TABLE "invoices" ALTER COLUMN status SET DEFAULT 'PENDING'::"InvoiceStatus";
...
ALTER TABLE "classifications" ALTER COLUMN status DROP DEFAULT;
ALTER TABLE "classifications" ALTER COLUMN status TYPE "ClassificationStatus" USING status::text::"ClassificationStatus";
ALTER TABLE "classifications" ALTER COLUMN status SET DEFAULT 'CLASSIFIED'::"ClassificationStatus";
